...
import { BuildingOfficeIcon, MailIcon, PhoneIcon } from '@/components/SocialIcons'
...
export default function Example() {
  return (
    <SimpleLayout
      title="Get In Touch!"
      intro="I try to be available to answer questions and respond promptly"
    >
        ...
        <dl className="mt-10 space-y-4 text-base leading-7">
              ...
              <div className="flex gap-x-4">
                <dt className="flex-none">
                  ...
                  <PhoneIcon className="h-7 w-6 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300" aria-hidden="true" />
                </dt>
                <dd>
                  <a className="hover:" href="tel:+1 (707) 707-6843">
                    +1 (707) 770-6843
                  </a>
                </dd>
              </div>
              ...
              <SocialVertical className="flex gap-x-4"/>
            </dl>
            
        </div>
        <form action="#" method="POST" className="px-6 pb-24 pt-20 sm:pb-32 lg:px-8 lg:py-4 flex-1">
